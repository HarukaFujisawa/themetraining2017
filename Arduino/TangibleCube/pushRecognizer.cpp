...
void pushRecognizer::init()
{
    uint8_t osrs_t = 1;             //Temperature oversampling x 1
    uint8_t osrs_p = 1;             //Pressure oversampling x 1
    uint8_t osrs_h = 1;             //Humidity oversampling x 1
    uint8_t mode = 3;               //Normal mode
    uint8_t t_sb = 0;               //Tstandby 0.5ms(2000fps)
    uint8_t filter = 4;             //Filter coefficient 16 
...
void pushRecognizer::updateData()
{
...
void pushRecognizer::writeReg(uint8_t reg_address, uint8_t data)
{
    Wire.beginTransmission(BME280_ADDRESS);
...
signed long int pushRecognizer::calibration_T(signed long int adc_T)
{
...
unsigned long int pushRecognizer::calibration_P(signed long int adc_P)
{
...
unsigned long int pushRecognizer::calibration_H(signed long int adc_H)
{
